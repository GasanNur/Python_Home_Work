...
# cобирающий модуль, находясь перед некоторым кустом заданной во входном файле грядки.

from random import randint

list_1 =list(randint(1,6) for i in range (8))
print(list_1)
first_bush_number= int(input('Введите номер куста: '))
res=0
if first_bush_number ==1:
    res = list_1[0]+list_1[1]+list_1[-1]
elif first_bush_number == len(list_1):
    res= list_1[-2] + list_1[-1] +list_1 [0]
else:
    res = list_1[first_bush_number-1] + list_1[first_bush_number-2] +list_1[first_bush_number] 
print(res)
